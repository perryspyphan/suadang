...
"[project]/src/infrastructure/supabase/server.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/infrastructure/supabase/repositories/SupabaseProductRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/server.ts [app-route] (ecmascript)");
...
class SupabaseProductRepository {
    ...
    async getAll(filters) {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])();
    ...
    async add(data) {
        ...
        if (error) throw new Error(error.message);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/hang-hoa');
    }
...
"[project]/src/infrastructure/supabase/repositories/SupabaseOrderRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SupabaseOrderRepository {
    ...
    async resolveConflict(conflictId, resolution) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/giao-dich/dat-hang/khach-hang');
    }
}
}),
"[project]/src/domain/value-objects/CustomerTier.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/infrastructure/supabase/repositories/SupabaseCustomerRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/server.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/cache.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$value$2d$objects$2f$CustomerTier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/domain/value-objects/CustomerTier.ts [app-route] (ecmascript)");
;
;
;
class SupabaseCustomerRepository {
    ...
    async add(form) {
        ...
        if (error) throw new Error(error.message);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/khach-hang');
    }
    ...
    async syncTier(customerId) {
        ...
        if (!c) return;
        const newTier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$value$2d$objects$2f$CustomerTier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calcTier"])(c.total);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$value$2d$objects$2f$CustomerTier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldUpgrade"])(c.tier, newTier)) {
...
"[project]/src/infrastructure/supabase/repositories/SupabaseDistributorRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SupabaseDistributorRepository {
    ...
    async add(form) {
        ...
        if (error) throw new Error(error.message);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/nha-phan-phoi');
    }
    async update(id, form) {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])();
...
"[project]/src/infrastructure/supabase/repositories/SupabaseStaffRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SupabaseStaffRepository {
    ...
    async addEmployee(form) {
        ...
        if (error) throw new Error(error.message);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/nhan-vien');
    }
    ...
    async addAccount(form) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/tai-khoan');
    }
    ...
    async verifyPin(accountId, pin) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(pin, data.pin_hash);
    }
    async updatePin(accountId, pin) {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])();
        // Hash PIN trước khi lưu (salt rounds = 10)
        const pin_hash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(pin, 10);
        const { error } = await supabase.schema('nhan_su').from('accounts').update({
            pin_hash
        }).eq('id', accountId);
        if (error) throw new Error(error.message);
...
"[project]/src/infrastructure/supabase/repositories/SupabaseCashbookRepository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/infrastructure/container/DIContainer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseProductRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseProductRepository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseOrderRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseOrderRepository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCustomerRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseCustomerRepository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseDistributorRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseDistributorRepository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseStaffRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseStaffRepository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCashbookRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/supabase/repositories/SupabaseCashbookRepository.ts [app-route] (ecmascript)");
;
;
;
;
...
function getCustomerRepository() {
    if (!customerRepo) customerRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCustomerRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseCustomerRepository"]();
    return customerRepo;
}
function getDistributorRepository() {
    if (!distributorRepo) distributorRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseDistributorRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseDistributorRepository"]();
    return distributorRepo;
}
function getStaffRepository() {
    if (!staffRepo) staffRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseStaffRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseStaffRepository"]();
    return staffRepo;
}
function getOrderRepository() {
    if (!orderRepo) orderRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseOrderRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseOrderRepository"]();
    return orderRepo;
}
function getProductRepository() {
    if (!productRepo) productRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseProductRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseProductRepository"]();
    return productRepo;
}
function getPhieuThuChiRepository() {
    if (!phieuRepo) phieuRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCashbookRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabasePhieuThuChiRepository"]();
    return phieuRepo;
}
function getLoaiThuChiRepository() {
    if (!loaiRepo) loaiRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCashbookRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseLoaiThuChiRepository"]();
    return loaiRepo;
}
function getTaiKhoanQuyRepository() {
    if (!taiKhoanRepo) taiKhoanRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$supabase$2f$repositories$2f$SupabaseCashbookRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SupabaseTaiKhoanQuyRepository"]();
    return taiKhoanRepo;
}
}),
"[project]/src/app/api/dashboard-summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/container/DIContainer.ts [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        const orderRepo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrderRepository"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dad7de5b._.js.map