...
"[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// src/application/use-cases/cashbook/CashbookUseCases.ts
/* __next_internal_action_entry_do_not_use__ [{"006b576a8f025017b2eecff4ed085826e7b0584305":"getTongQuy","00a131fbfc31857fe45e057271cfdbc3b25774e58d":"getTaiKhoanQuy","4017576c282d1f1848646cd078e7dc7e5dc62a1104":"themLoaiThuChi","401f4196bd406fec395df277639240f81e7111eb16":"xuatCsvSoQuy","4025a7a1994aba6ff4c27f144424b8328fbe172289":"lapPhieuThu","4063e4fe494a40597510663ca709d4212e773a24c3":"getLoaiThuChi","4083646e33c4f9c4233f5f6c847003ccdae6e8e2ba":"xoaTaiKhoanQuy","4093f232dad89e73bf05980ca1db5c50b2e6641ac9":"huyPhieu","40aa8e3079cf767c6683d199b916c6e85812acac76":"xoaLoaiThuChi","40ac428944286be532e01be159f7f01ab6af602cd8":"lapPhieuChi","40b53326a61fe2a5c644dcf5844f22384ec94b4edf":"themTaiKhoanQuy","40c27a3cd915815a2af36a10da9b118cc4bd00bdce":"getPhieuById","40d29dd586b0873663adf66fdb91546cb9b0ecd010":"getDanhSachPhieu","6043b840a9f237182918966ec0913052c1006b71d1":"capNhatPhieu","605091e3894dafb4df3d6ebaea72a7599d8f34f515":"suaTaiKhoanQuy"},"",""] */ __turbopack_context__.s([
    "capNhatPhieu",
    ()=>capNhatPhieu,
    "getDanhSachPhieu",
    ()=>getDanhSachPhieu,
...
async function getDanhSachPhieu(filter = {}) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().findAll({
        page: 1,
        page_size: 20,
        ...filter
    });
}
async function getPhieuById(id) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().findById(id);
}
async function lapPhieuThu(form) {
    ...
    const taiKhoan = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().findById(form.tai_khoan_quy_id);
    if (!taiKhoan) throw new Error('Tài khoản quỹ không tồn tại');
    const ma_phieu = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().genMaPhieu(getPrefix('thu', taiKhoan.loai));
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().create({
        ...form,
        kieu: 'thu',
        ma_phieu,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function lapPhieuChi(form) {
    if (!form.loai_thu_chi_id) throw new Error('Vui lòng chọn loại chi');
    if (!form.gia_tri || form.gia_tri <= 0) throw new Error('Giá trị phải lớn hơn 0');
    const taiKhoan = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().findById(form.tai_khoan_quy_id);
    if (!taiKhoan) throw new Error('Tài khoản quỹ không tồn tại');
    const ma_phieu = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().genMaPhieu(getPrefix('chi', taiKhoan.loai));
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().create({
        ...form,
        kieu: 'chi',
        ma_phieu,
...
async function capNhatPhieu(id, form) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().update(id, form);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function huyPhieu(id) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().huy(id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function getLoaiThuChi(kieu) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLoaiThuChiRepository"])().findAll(kieu);
}
async function themLoaiThuChi(form) {
    if (!form.ten?.trim()) throw new Error('Tên loại không được rỗng');
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLoaiThuChiRepository"])().create(form);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function xoaLoaiThuChi(id) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLoaiThuChiRepository"])().delete(id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
}
async function getTaiKhoanQuy() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().findAll();
}
async function getTongQuy() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().getTongQuy();
}
async function themTaiKhoanQuy(form) {
    if (!form.ten_tai_khoan?.trim()) throw new Error('Tên tài khoản không được rỗng');
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().create(form);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function suaTaiKhoanQuy(id, form) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().update(id, form);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
    return result;
}
async function xoaTaiKhoanQuy(id) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuyRepository"])().delete(id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/so-quy');
}
async function xuatCsvSoQuy(filter) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$container$2f$DIContainer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPhieuThuChiRepository"])().findAll({
        ...filter,
        page: 1,
        page_size: 10000
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getDanhSachPhieu, "40d29dd586b0873663adf66fdb91546cb9b0ecd010", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPhieuById, "40c27a3cd915815a2af36a10da9b118cc4bd00bdce", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(lapPhieuThu, "4025a7a1994aba6ff4c27f144424b8328fbe172289", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(lapPhieuChi, "40ac428944286be532e01be159f7f01ab6af602cd8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(capNhatPhieu, "6043b840a9f237182918966ec0913052c1006b71d1", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(huyPhieu, "4093f232dad89e73bf05980ca1db5c50b2e6641ac9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getLoaiThuChi, "4063e4fe494a40597510663ca709d4212e773a24c3", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(themLoaiThuChi, "4017576c282d1f1848646cd078e7dc7e5dc62a1104", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(xoaLoaiThuChi, "40aa8e3079cf767c6683d199b916c6e85812acac76", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTaiKhoanQuy, "00a131fbfc31857fe45e057271cfdbc3b25774e58d", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTongQuy, "006b576a8f025017b2eecff4ed085826e7b0584305", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(themTaiKhoanQuy, "40b53326a61fe2a5c644dcf5844f22384ec94b4edf", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(suaTaiKhoanQuy, "605091e3894dafb4df3d6ebaea72a7599d8f34f515", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(xoaTaiKhoanQuy, "4083646e33c4f9c4233f5f6c847003ccdae6e8e2ba", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(xuatCsvSoQuy, "401f4196bd406fec395df277639240f81e7111eb16", null);
}),
"[project]/.next-internal/server/app/(admin)/so-quy/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/(admin)/so-quy/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "006b576a8f025017b2eecff4ed085826e7b0584305",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTongQuy"],
    "00a131fbfc31857fe45e057271cfdbc3b25774e58d",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaiKhoanQuy"],
    "4017576c282d1f1848646cd078e7dc7e5dc62a1104",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["themLoaiThuChi"],
    "4025a7a1994aba6ff4c27f144424b8328fbe172289",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["lapPhieuThu"],
    "4063e4fe494a40597510663ca709d4212e773a24c3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLoaiThuChi"],
    "4083646e33c4f9c4233f5f6c847003ccdae6e8e2ba",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["xoaTaiKhoanQuy"],
    "4093f232dad89e73bf05980ca1db5c50b2e6641ac9",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["huyPhieu"],
    "40aa8e3079cf767c6683d199b916c6e85812acac76",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["xoaLoaiThuChi"],
    "40ac428944286be532e01be159f7f01ab6af602cd8",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["lapPhieuChi"],
    "40b53326a61fe2a5c644dcf5844f22384ec94b4edf",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["themTaiKhoanQuy"],
    "40d29dd586b0873663adf66fdb91546cb9b0ecd010",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDanhSachPhieu"],
    "6043b840a9f237182918966ec0913052c1006b71d1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["capNhatPhieu"],
    "605091e3894dafb4df3d6ebaea72a7599d8f34f515",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["suaTaiKhoanQuy"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$admin$292f$so$2d$quy$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(admin)/so-quy/page/actions.js { ACTIONS_MODULE0 => "[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$application$2f$use$2d$cases$2f$cashbook$2f$CashbookUseCases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/application/use-cases/cashbook/CashbookUseCases.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__b753eeb6._.js.map